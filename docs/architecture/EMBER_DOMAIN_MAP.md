# EMBER_DOMAIN_MAP — Subsystem Ownership for the Three Realms

**Voice:** Architect (Rúnhild Svartdóttir)
**Status:** Proposed — for ratification. Bootstrap-stage. Additive to the inherited `DOMAIN_MAP.md` (which describes Runa's parent shape and is preserved at its canonical path).
**Last touched:** 2026-05-21
**Reads with:** `EMBER_ARCHITECTURE.md` (shape), `docs/SYSTEM_VISION.md` (intent), `EMBER_DATA_FLOW.md` (motion).
...
- [ ] The new code respects the dependency law in `EMBER_ARCHITECTURE.md` §2.
