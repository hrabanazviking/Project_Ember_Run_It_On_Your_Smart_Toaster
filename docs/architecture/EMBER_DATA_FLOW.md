# EMBER_DATA_FLOW — How Ember Lives in Motion

**Voice:** Cartographer (Védis Eikleið)
**Status:** Proposed — for ratification. Bootstrap-stage. Additive to the inherited `DATA_FLOW.md` (which describes Runa's flow shape and is preserved at its canonical path).
**Last touched:** 2026-05-21
**Reads with:** `EMBER_ARCHITECTURE.md` (shape), `EMBER_DOMAIN_MAP.md` (ownership), `docs/SYSTEM_VISION.md` (intent).
